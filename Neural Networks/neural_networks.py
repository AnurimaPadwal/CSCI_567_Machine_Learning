...
class linear_layer:
    ...
    def __init__(self, input_D, output_D):
        ...
        #raise NotImplementesedError("Not Implemented function: __init__, class: linear_layer")
...
class tanh:
    ...
    def forward(self, X):
        ...
        forward_output = 2.0/(1 + np.exp(-2*X)) - 1
    ...
    def backward(self, X, grad):
        ...
        ####################################################################################################
        backward_output = grad * (1 - np.power(np.tanh(X),2))
